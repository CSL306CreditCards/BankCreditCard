...
urlpatterns = patterns('',
	...
	url(r'^creditcard/home/forgetpassword.html', 'creditcard.views.forgetPassword'),
    url(r'^creditcard/home/forgetpassword.html/password_sent/','creditcard.views.sendPassword'),
